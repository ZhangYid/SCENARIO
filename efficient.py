...
if __name__ == '__main__':
    ...
    print(len(gr.nodes))
    print(len(gr.edges))
    gene_pair = pd.read_csv("label_result816/negative_pair_800.csv")
    gene_pair2 = pd.read_csv("label_result816/postive_pair_50_2.csv")
    max_length = 4
    ...
    for pair in gene_pair:
        ...
        slice = random.sample(gene_nodes, 5431)
        cores_for_gene1=math.floor(cores/2)
        cores_for_gene2=cores-cores_for_gene1
        multi_prcoessing_data1=create_multi_task_data(slice,cores_for_gene1,max_length,g1,meta_path_limit,cores,graphs1)
        multi_prcoessing_data2=create_multi_task_data(slice,cores_for_gene2,max_length,g2,meta_path_limit,cores,graphs2)
        ...
        #for i in multi_prcoessing_data:
         #   final_score_list=final_score_list+mutil_prcoessing(i)
    ...
    during_time =(end_time - start_time) / 10
